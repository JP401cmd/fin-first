...
export function AssetForm({
  ...
  const [saleDraft, setSaleDraft] = useState<SaleConfigDraft>(() => saleConfigToDraft(asset?.sale_config))
  ...
  async function handleSave() {
    ...
    const saleConfigPayload: SaleConfig | null = showSaleConfigOnSave ? draftToSaleConfig(saleDraft) : null
