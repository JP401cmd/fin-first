    ...
    <div className="space-y-4">
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-lg border border-zinc-200 py-2.5 pl-9 pr-3 text-sm text-zinc-900 outline-none placeholder:text-zinc-400 focus:border-kern-500 focus:ring-1 focus:ring-kern-500"
          autoFocus
        />
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
        {filtered.map((inst) => (
          <button
            ...
            className="flex flex-col items-center gap-2 rounded-xl border border-zinc-200 bg-white p-4 transition-all hover:border-kern-300 hover:bg-kern-50 hover:shadow-sm"
          >
            {inst.logo ? (
