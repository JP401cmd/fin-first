...
// Berekening woont nu in lib/horizon/compound-interest.ts (import-richting UI→lib).
import { computeCompoundInterest, type CompoundInterestRow } from '@/lib/horizon/compound-interest'
