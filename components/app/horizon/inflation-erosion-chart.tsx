...
// Berekening woont nu in lib/horizon/inflation-erosion.ts (import-richting UI→lib).
import { computeInflationErosion, type InflationRow } from '@/lib/horizon/inflation-erosion'
export { computeInflationErosion }
