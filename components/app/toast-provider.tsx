...
type ToastContextType = {
  ...
  showBadgeEarned: (badge: { name: string; icon: string; description: string }) => void
}
...
function ToastItem({
  ...
  const bgMap: Record<ToastType, string> = {
    ...
    badge: 'bg-gradient-to-r from-amber-50 to-teal-50 border-amber-300 text-zinc-900',
  }
...
export function ToastProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <ToastContext.Provider value={{ toasts, addToast, removeToast, showBadgeEarned }}>
      {children}
