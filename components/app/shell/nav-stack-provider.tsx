 ...
 *    (PrivacyToggle + News + Bell + Avatar-dropdown). Visueel breed, vergelijkbaar
 *    met de oude `AppHeader` op mobile.
...
/**
 * Leid de active tab af uit de pathname. Plan §4 mapping:
 *  - /core/**     → kern
 *  - /will/**     → wil
 *  - /horizon/**  → horizon
 *  - /identity/** → identity
 ...
 * resetten naar single-entry bij root-bezoek (auto-pop tot de root).
 */
function isTabRoot(pathname: string, tab: TabId): boolean {
  switch (tab) {
    case 'kern': return pathname === '/core'
    case 'wil': return pathname === '/will'
    case 'horizon': return pathname === '/horizon'
    case 'identity': return pathname === '/identity'
