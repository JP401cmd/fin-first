        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4" onClick={() => setEditingIndex(null)}>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              {/* Minimum payment */}
              <div>
                <label className="mb-1 block text-xs font-medium text-zinc-600">Minimale aflossing / maand</label>
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-sm text-zinc-400">&euro;</span>
                  <input
                    type="number"
              ...
              {/* Monthly payment */}
              <div>
                <label className="mb-1 block text-xs font-medium text-zinc-600">Werkelijke maandbetaling</label>
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-sm text-zinc-400">&euro;</span>
                  <input
                    type="number"
              ...
              {visibleFields.includes('repayment_type') && (
                <div>
                  <label className="mb-1 block text-xs font-medium text-zinc-600">Aflossingsvorm</label>
                  <select
              ...
              {visibleFields.includes('fixed_rate_end_date') && (
                <div>
                  <label className="mb-1 block text-xs font-medium text-zinc-600">Einddatum rentevaste periode</label>
                  <input
                    type="date"
              ...
              {visibleFields.includes('draagkrachtmeting_date') && (
                <div>
                  <label className="mb-1 block text-xs font-medium text-zinc-600">Datum draagkrachtmeting</label>
                  <input
                    type="date"
