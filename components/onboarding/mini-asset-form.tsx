...
export function MiniAssetForm({
  ...
  function save() {
    if (!draft.name || !draft.current_value || duplicateName) return
    if (editingIndex === -1) {
        ...
        <div className="p-4 sm:p-5 [&_input]:text-base [&_input]:sm:text-sm [&_select]:text-base [&_select]:sm:text-sm">
            <div className="space-y-3">
              ...
              <div>
                ...
                />
                {duplicateName && (
                  <p className="mt-1 text-[11px] text-red-500">Er bestaat al een bezitting met deze naam</p>
                )}
              </div>
            ...
            <div className="mt-5 flex gap-3">
              ...
              <button
                onClick={save}
                disabled={!draft.name || !draft.current_value || duplicateName}
