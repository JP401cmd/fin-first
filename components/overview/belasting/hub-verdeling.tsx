 ...
 * bedragen). Box-kleuren volgen de huisstijl: Box 1 amber, Box 2 violet,
 * Box 3 teal. Box 2 verschijnt alleen als segment wanneer er een bedrag is
 * (anders zou een 0-segment de legenda vervuilen).
 *
...
const BOX1_COLOR = '#b45309' // amber
const BOX2_COLOR = '#7c3aed' // violet
const BOX3_COLOR = '#0d9488' // teal
