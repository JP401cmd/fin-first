 ...
 * lib/regression-tests/suites/whatif-scenarios.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/whatif-scenarios'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('whatif-scenarios', register)
