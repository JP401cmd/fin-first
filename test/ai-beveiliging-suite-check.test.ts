 ...
 * lib/regression-tests/suites/ai-beveiliging.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/ai-beveiliging'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('ai-beveiliging', register)
