 ...
 * lib/regression-tests/suites/feature-gating.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/feature-gating'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('feature-gating', register)
