 ...
 * lib/regression-tests/suites/kern-formatting.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/kern-formatting'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('kern-formatting', register)
