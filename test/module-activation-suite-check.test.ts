 ...
 * lib/regression-tests/suites/module-activation.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/module-activation'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('module-activation', register)
