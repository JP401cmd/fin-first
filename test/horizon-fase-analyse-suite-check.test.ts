 ...
 * lib/regression-tests/suites/horizon-fase-analyse.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/horizon-fase-analyse'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('horizon-fase-analyse', register)
