 ...
 * lib/regression-tests/suites/sovereignty-levels.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/sovereignty-levels'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('sovereignty-levels', register)
