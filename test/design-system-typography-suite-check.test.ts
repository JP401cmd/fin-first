 ...
 * lib/regression-tests/suites/design-system-typography.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/design-system-typography'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('design-system-typography', register)
