 ...
 * lib/regression-tests/suites/levensgebeurtenissen-classificatie.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/levensgebeurtenissen-classificatie'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('levensgebeurtenissen-classificatie', register)
