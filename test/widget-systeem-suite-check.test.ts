 ...
 * lib/regression-tests/suites/widget-systeem.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/widget-systeem'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('widget-systeem', register)
