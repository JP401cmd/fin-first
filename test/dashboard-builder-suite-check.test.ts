 ...
 * lib/regression-tests/suites/dashboard-builder.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/dashboard-builder'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('dashboard-builder', register)
