 ...
 * lib/regression-tests/suites/wil-gezondheid.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/wil-gezondheid'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('wil-gezondheid', register)
