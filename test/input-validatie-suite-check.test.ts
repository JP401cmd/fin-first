 ...
 * lib/regression-tests/suites/input-validatie.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/input-validatie'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('input-validatie', register)
