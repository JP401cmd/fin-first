 ...
 * lib/regression-tests/suites/horizon-grafiek.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/horizon-grafiek'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('horizon-grafiek', register)
