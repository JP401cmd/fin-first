 ...
 * lib/regression-tests/suites/onttrekkingsstrategie.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/onttrekkingsstrategie'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('onttrekkingsstrategie', register)
