 ...
 * lib/regression-tests/suites/wil-aanbevelingen.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/wil-aanbevelingen'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('wil-aanbevelingen', register)
