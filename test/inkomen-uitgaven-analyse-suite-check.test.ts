 ...
 * lib/regression-tests/suites/inkomen-uitgaven-analyse.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/inkomen-uitgaven-analyse'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('inkomen-uitgaven-analyse', register)
