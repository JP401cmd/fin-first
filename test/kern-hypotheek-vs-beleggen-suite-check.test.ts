 ...
 * lib/regression-tests/suites/kern-hypotheek-vs-beleggen.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/kern-hypotheek-vs-beleggen'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('kern-hypotheek-vs-beleggen', register)
