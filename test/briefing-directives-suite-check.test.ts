 ...
 * lib/regression-tests/suites/briefing-directives.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/briefing-directives'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('briefing-directives', register)
