 ...
 * lib/regression-tests/suites/box3-belasting.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/box3-belasting'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('box3-belasting', register)
