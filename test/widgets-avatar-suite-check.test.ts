 ...
 * lib/regression-tests/suites/widgets-avatar.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/widgets-avatar'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('widgets-avatar', register)
