 ...
 * lib/regression-tests/suites/design-system-tokens.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/design-system-tokens'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('design-system-tokens', register)
