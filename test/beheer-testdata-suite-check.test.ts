 ...
 * lib/regression-tests/suites/beheer-testdata.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/beheer-testdata'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('beheer-testdata', register)
