 ...
 * lib/regression-tests/suites/horizon-parameters.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/horizon-parameters'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('horizon-parameters', register)
