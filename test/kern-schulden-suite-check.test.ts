 ...
 * lib/regression-tests/suites/kern-schulden.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/kern-schulden'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('kern-schulden', register)
