 ...
 * lib/regression-tests/suites/levensgebeurtenissen-ui.ts.
 *
 ...
 */
import { register } from '@/lib/regression-tests/suites/levensgebeurtenissen-ui'
import { describeRegressionSuite } from './helpers/regression-suite-runner'

describeRegressionSuite('levensgebeurtenissen-ui', register)
