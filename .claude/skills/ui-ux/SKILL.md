...
- **Inkt-op-papier**: warm off-white (`--bg`/`--paper`), nooit klinisch wit of donker. Eén bewuste uitzondering: de mobiele TopBar, die chrome is en geen pagina (leisteen via `--topbar-*`, ADR 0174 en *Mobile TopBar* in `pattern-cards.md`).
