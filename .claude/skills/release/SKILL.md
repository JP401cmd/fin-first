...
1. **Bump-niveau uit de diff:** alleen fixes → patch (`0.89.0` → `0.89.1`); nieuwe of uitgebreide functionaliteit → minor (`0.90.0`); nooit major. Alleen een run van deze skill bumpt — `checkpoint`-commits en losse pushes niet.
