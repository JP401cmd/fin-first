...
### 6. Review — fork-review
Een **fork-subagent** (`subagent_type: "fork"` — níet de `code-review`-agent, zie de gedeelde conventies), met als expliciete reviewvraag: is dit een pure move? Elke inhoudelijke wijziging in de diff is een bevinding, hoe goedbedoeld ook.
