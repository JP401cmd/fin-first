...
const criteria: AcceptanceCriterion[] = [
  ...
  },
  {
    ...
    kriticiteit: 'BELANGRIJK',
    given: 'Budget-kind-dots (Transacties/Vaste lasten/Forecast) en belasting-kind-dots (Box 1/2/3) in de sidebar. HERZIEN 06-09-2026 (ADR 0135): "Budget" is de OUDER geworden en staat niet meer als kind onder zichzelf; zijn eigen dot komt uit `leverKey: cashflow` (de hefboomscore uit `loadLeverScores`), de drie kinderen uit `buildCashflowCards`.',
