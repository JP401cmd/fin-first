...
const criteria: AcceptanceCriterion[] = [
  ...
  },
  {
    ...
    assertion: {
      ...
      source: 'current_balance × pct/100 (lib/dashboard-data-loader.ts r514-515, inclusion-gewogen debt-som — regelnummer bijgewerkt na de cashflow-kaarten-fix van 30 jul; de formule zelf is ongewijzigd); delta = volle saldo − effectief saldo',
    },
  },
  {
