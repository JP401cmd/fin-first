...
const criteria: AcceptanceCriterion[] = [
  ...
  },
  {
    ...
    when:
      'De uitkomst-switch `resolveLabUitkomst` wordt op de vijf toestanden aangeroepen; bij toestand (2) legt de gebruiker het scenario vervolgens vast als doel via `buildParameterGoalRows` met parameter `dekking`; op toestand (2) wordt `resolveLabAntwoorden` aangeroepen met de tweede run (solvedFireAge 70) en de plan-hint `planMaandHint` €500 (P!B96 van de hoofd-run — nooit de hint van een verkend stop-pad) op een basis van €4.000/mnd.',
    then:
