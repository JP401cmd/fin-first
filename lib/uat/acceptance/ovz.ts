...
const criteria: AcceptanceCriterion[] = [
  ...
  },
  {
    ...
    then: 'Schuldratio = 13.900/9.700 = 1,433 (143%) ≥ 1 → pijlerscore 0 → statuskleur rood (via `pillarStatus`, <50 → bad).',
    assertion: {
      kind: 'exact',
  ...
  },
  {
    ...
    titel: 'Hero-widgets samenstellen',
    kriticiteit: 'BELANGRIJK',
  ...
  },
  {
    ...
    assertion: {
      ...
      source: 'lib/briefing/overview-briefing.ts#computeFreedomTotal — échte productiefunctie, geen mirror',
    },
  },
  {
    workflow: 'WF-OVZ-10',
  ...
  },
  {
    ...
    when: 'De gebruiker vinkt stappen af, navigeert door schermen en sluit de gids.',
    then: '"Volgende keer verder" verbergt de gids voor deze sessie; "Geen onboarding-schermen meer tonen" sluit hem voorgoed (nooit meer terug, ook niet na uit-/inloggen). Puur voortgangs-/zichtbaarheids-state, geen eigen berekening.',
    assertion: {
      kind: 'ui-only',
