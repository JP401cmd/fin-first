...
const criteria: AcceptanceCriterion[] = [
  ...
  },
  {
    ...
    when: 'De gebruiker begint bij "naam" — de AI-keuze is met ADR 0157 uit de onboarding gehaald (WF-START-30 speelt nu pas in de app) — en doorloopt de stappen "inkomen"/"uitgaven" (spaarquote-preview), "uitgaven na pensioen" (prefill), "spaardoel" (Noodfonds-preset), "Jouw plan" (standaardpad — twee vragen, zie WF-START-28) en "klaar" (recap). Na "Begin met TriFinity" volgt sinds ADR 0156 NIET direct het successcherm: ná de opslag komen eerst de afrondingsstappen budget (WF-START-31..33) en bank (WF-START-34..36) in groep 9/9, pas daarna het successcherm en de landing in de app.',
