...
export const BEHEER_FLOW: UatFlow = {
  ...
  nodes: [
    ...
    { id: 'nieuws-poort', scenarioId: 'UAT-BEHEER-40', label: 'WF-BEHEER-40 · Tekstpoort meten (G1–G5) + steekproef (G7)', kind: 'action', stage: 3, lane: 'functioneel', subOf: 'sectie-func' },
    ...
    { id: 'gebruik-analyse', scenarioId: 'UAT-BEHEER-39', label: 'WF-BEHEER-39 · Gebruik per waardestroom (anoniem, k=5)', kind: 'screen', stage: 3, lane: 'info', subOf: 'sectie-info' },
