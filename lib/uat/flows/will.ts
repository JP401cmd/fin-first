// Gecureerde Will-procesflow (verdiepingslaag laag 2 voor de UAT-plaat).
//
// Bron: docs/uat/uat-plan.md Deel 1 — "Will (AI-coach), berichten & krant
...
export const WILL_FLOW: UatFlow = {
  ...
  nodes: [
    // ── 0 · instap ────────────────────────────────────────────────────────
    { id: 'nav', label: 'Will-bubbel/bel/krant-icoon zichtbaar op elke pagina', kind: 'entry', stage: 0 },
    ...
    // ── 1 · chat-kern ─────────────────────────────────────────────────────
    { id: 'vraag', scenarioId: 'UAT-WILL-01', label: 'WF-WILL-01 · Vrije vraag stellen aan Will', kind: 'screen', stage: 1, lane: 'chat' },
    ...
    { id: 'bespreek', scenarioId: 'UAT-WILL-07', label: 'WF-WILL-07 · "Bespreek met Will" vanaf een onderwerp', kind: 'action', stage: 1, lane: 'chat' },
    ...
    { id: 'opvolgen', scenarioId: 'UAT-WILL-12', label: 'WF-WILL-12 · Melding opvolgen (doorklikken/Will vragen)', kind: 'action', stage: 2, lane: 'meldingen', subOf: 'bel' },
    ...
    { id: 'artikelbespreek', scenarioId: 'UAT-WILL-18', label: 'WF-WILL-18 · Nieuwsartikel met Will bespreken', kind: 'action', stage: 3, lane: 'krant', subOf: 'krant' },
    ...
    { id: 'x-toek', label: 'Toekomst · "Bespreek met Will"-knoppen bij fase-analyses/tijdas', kind: 'cross', stage: 5, crossZone: 'TOEK' },
  ],
  edges: [
    // instap
