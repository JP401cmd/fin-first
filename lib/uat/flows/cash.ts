...
export const CASH_FLOW: UatFlow = {
  ...
  nodes: [
    ...
    // ── 1 · verkennen ─────────────────────────────────────────────────────
    { id: 'geldstroom', scenarioId: 'UAT-CASH-02', label: 'WF-CASH-02 · Geldstroom bekijken (periodekiezer) & door maanden bladeren', kind: 'screen', stage: 1, lane: 'verkennen' },
    { id: 'kassabon', scenarioId: 'UAT-CASH-03', label: 'WF-CASH-03 · Kassabon inkomsten/uitgaven (gekozen periode)', kind: 'screen', stage: 1, lane: 'verkennen', subOf: 'geldstroom' },
    ...
    { id: 'grenzenpotbereikt', scenarioId: 'UAT-CASH-67', label: 'WF-CASH-67 · Grenzenpot precies op de grens: "Grens bereikt" als vierde weergave-stand (ADR 0136)', kind: 'action', stage: 3, lane: 'transacties', subOf: 'grenzenpotberekenen' },
  ...
  edges: [
    ...
    { from: 'nav-rekeningen', to: 'rekeningen' },
    ...
    { from: 'grenzenpotberekenen', to: 'grenzenpotbereikt' },
    ...
    { from: 'grenzenpotbereikt', to: 'uitkomst' },
