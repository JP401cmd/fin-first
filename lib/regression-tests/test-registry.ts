...
export async function loadAllTests(): Promise<void> {
  ...
  const results = await Promise.allSettled([
    ...
    import('@/lib/regression-tests/suites/invulfase-checklist').then(m => m.register()).catch(e => { console.warn('[test-registry] invulfase-checklist failed:', e) }),
    import('@/lib/regression-tests/suites/welcome-krant').then(m => m.register()).catch(e => { console.warn('[test-registry] welcome-krant failed:', e) }),
