...
// ── Schenk- & erfbelasting (jaargelaagd, analoog aan BOX3_PARAMS) ────────────
//
// Eén bron van waarheid voor de Nederlandse schenk- en erfbelasting. De
// vrijstellingen, de eenmalig verhoogde schenkvrijstelling en de schijfgrens
// zijn jaargebonden; de tariefpercentages (10/20 · 18/36 · 30/40%) zijn
// wettelijk jaaronafhankelijk en staan daarom één keer (geen jaar-duplicatie).
// Alle bedragen geverifieerd tegen de Belastingdienst-tariefbladen per jaar.
...
export const LIFE_EVENT_CATALOG: Record<string, LifeEventCatalogEntry> = {
  ...
  inheritance: {
    ...
    fields: [
      ...
      { key: 'erfbelastingSchijf', label: 'Relatie tot erflater', fieldType: 'select', default: 'kind', options: formatErfenisRelatieOpties(), tip: formatErfenisRelatieTip() },
