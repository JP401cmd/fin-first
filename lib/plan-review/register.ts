...
export const KERNEL_INPUT_REVIEW_REGISTER: Record<keyof KernelInput, { dekking: PlanReviewDekking; toelichting: string }> = {
  ...
  assetPotten: { dekking: 'brondata', toelichting: 'Bezittingen zelf; rendement per bezitting en sale_config via het bezittingenoverzicht (laag 2 verwijst).' },
  ...
  autoGebeurtenissen: { dekking: 'inkomsten', toelichting: 'AOW-event (leefsituatie, jaren buiten NL) en pensioenpotten.' },
  partner: { dekking: 'brondata', toelichting: 'Huishoudtype/partnerkoppeling (/mijn/profiel); hoofdgrafiek draait solo.' },
  werkStrategie: { dekking: 'inkomsten', toelichting: 'Optionele werk-strategie (life_event werk) — genoemd in stap 3.' },
  potMutaties: { dekking: 'kern-intern', toelichting: 'Generieke pot-mutaties (V9) — geen app-veld.' },
  potLiquidaties: { dekking: 'brondata', toelichting: 'sale_config per niet-liquide bezitting — bezittingenoverzicht (laag 2 verwijst).' },
