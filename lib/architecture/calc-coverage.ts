...
export const CALC_COVERAGE_IGNORE: CalcCoverageIgnoreEntry[] = [
  ...
  { file: 'lib/onboarding-completeness.ts', reason: 'Telt hoeveel van de zeven onboarding-onderdelen data bevatten ("6 van 7") — een UI-volledigheidsmeting, geen afgeleid financieel cijfer: er komt geen euro, percentage of vrijheidstijd uit. Vervangt de hardgecodeerde 100% op het eindscherm (bevinding M11).' },
