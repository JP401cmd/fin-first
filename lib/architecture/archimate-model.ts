...
export function buildArchimateModel(facts: ArchFacts): ArchimateModel {
  ...
  const ENRICH: Record<string, Enrichment> = {
    ...
    'as-planning->sp-plannen': { payload: 'FIRE-projecties, scenario’s en opnamestrategie', mechanism: 'compute', cadence: 'on-demand', contractDomains: ['scenarios', 'whatif', 'fire-settings', 'withdrawal-strategy', 'pot-rules'] },
