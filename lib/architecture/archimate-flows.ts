...
export const ARCHI_FLOWS: ArchiFlow[] = [
  {
    ...
    steps: [
      ...
      { elementId: 'as-planning', label: 'Spaarquote × inkomen → projectie', artifact: 'runUnifiedProjection', detail: 'Geïndexeerd in de unified-engine, met aflossing-dubbeltel-guard.' },
