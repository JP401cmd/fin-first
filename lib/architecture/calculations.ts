...
export const CALCULATIONS: Calculation[] = [
  ...
  },
  {
    ...
    files: ['lib/unified-projection.ts', 'lib/horizon-data.ts', 'lib/fire-simulation.ts', 'lib/household-type.ts'],
    functions: ['runUnifiedProjection', 'runSimulation', 'lifeEventsToCashflows', 'hasPartner'],
