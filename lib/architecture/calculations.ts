...
export const CALCULATIONS: Calculation[] = [
  ...
  },
  {
    ...
    functions: ['deriveRetirementExpenseBasis', 'extrapolateAnnualIncome', 'computeRetirementExpenses', 'computeYearlyMustExpenses', 'buildPersoonlijkPlanSections'],
    constants: [
