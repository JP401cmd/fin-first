...
export const CALCULATIONS: Calculation[] = [
  // ── Cashflow ──
  {
    ...
    files: ['lib/savings-source.ts', 'lib/month-range.ts', 'lib/dashboard-data-loader.ts'],
    functions: ['resolveSavingsSource', 'savingsRateFromAggregates', 'monthlySavingsFromRate', 'computeDebtAflossingMonthly', 'localMonthStartMonthsAgo'],
    constants: [
  ...
  },
  {
    ...
    domain: 'Toekomst (FIRE)',
    summary: 'Per leeftijd welk deel van de gewenste besteding gedekt is door vaste inkomsten (AOW/pensioen/salaris) + de gerealiseerde onttrekking. Voedt de stoplicht-strook op /toekomst.',
    inputs: ['UnifiedProjectionRow.grossIncomeBySource (salaris, gebeurtenisBaten)', 'UnifiedProjectionRow.withdrawal', 'UnifiedProjectionRow.withdrawalNeed.totaalNeed', 'UnifiedProjectionRow.phase'],
    outputs: ['dekkingsgraad % per gesampled leeftijd', 'stoplichtstatus (groen ≥100 / amber 90–99 / rood <90)'],
    formula: 'dekking% = (salaris + gebeurtenisBaten + withdrawal) / totaalNeed × 100; accumulatie/nul-behoefte → 100',
    files: ['lib/horizon/coverage-strip.ts'],
    functions: ['buildCoverageStrip'],
    elementIds: ['as-planning', 'fn-toekomstplannen'],
    note: 'Pure weergave-afleiding uit de bestaande unified-rijen — geen eigen rekenmotor, geen financiële constanten (alleen de presentatiedrempels 90/100 en de sample-stap). Consumeert de horizon-kernel-output; herberekent niets.',
  },
  {
