...
export const CALCULATIONS: Calculation[] = [
  ...
  },
  {
    ...
    files: ['lib/horizon-kernel/engine.ts', 'lib/horizon-kernel/solver.ts', 'lib/horizon-kernel/gap.ts', 'lib/horizon-kernel/bridge.ts', 'lib/horizon-kernel/run-unified.ts', 'lib/horizon-kernel/adapter/index.ts', 'lib/horizon-kernel/adapter/defaults.ts', 'lib/horizon-kernel/adapter/params.ts', 'lib/horizon-kernel/tables/*.ts', 'lib/horizon-kernel/wrappers/band.ts', 'lib/horizon-kernel/wrappers/mc.ts', 'lib/horizon-kernel/wrappers/hist.ts', 'lib/fire-target-shared.ts'],
  ...
  },
  {
    ...
    inputs: [
      ...
      'scenario-events (monthly_cost_change) voor het guardrail-kompas — exclusief de slider-werk-origins (isSliderWorkEvent)',
    ],
    outputs: [
