...
export const CALCULATIONS: Calculation[] = [
  ...
  },
  {
    ...
    constants: [
      { label: 'Rendement-delta-bereik', value: '±0,05 (±5 pp), stap 0,005 — spiegelt de Marktbias-slider (whatif-market-assumptions.tsx)' },
      { label: 'Slider-clamps', value: 'inkomen €0–15.000 · werkdagen 1–5 · spaarquote 0–80% · extra inleg €0–5.000 (whatif-sliders.tsx)' },
