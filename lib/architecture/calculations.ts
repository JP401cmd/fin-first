...
export const CALCULATIONS: Calculation[] = [
  ...
  },
  {
    ...
    inputs: [
      ...
      'verwacht beleggingsrendement + spaarrente-aanname (DEFAULT_RETURN / EXPECTED_SAVINGS_RETURN, lib/constants.ts)',
    ...
    constants: [
      ...
      { label: 'Rendementsaanname 2028-indicatie', value: 'gewogen gemiddelde van EXPECTED_SAVINGS_RETURN (spaargeld) en DEFAULT_RETURN (beleggingen) naar rato van de samenstelling — geen nieuwe constante' },
      ...
      { label: 'Verwacht beleggingsrendement', value: 'DEFAULT_RETURN = 7,0% nominaal (lib/constants.ts)' },
      { label: 'Spaarrente-aanname', value: 'EXPECTED_SAVINGS_RETURN = 1,3% nominaal (lib/constants.ts) — in lijn met het forfait sparen 2026 (1,28%); bewust een eigen economische aanname, niet afgeleid van het fiscale forfait' },
      { label: 'Verwacht rendementsgat (afgeleid)', value: 'DEFAULT_RETURN − EXPECTED_SAVINGS_RETURN ≈ 5,7 procentpunt per jaar over het verschoven bedrag' },
