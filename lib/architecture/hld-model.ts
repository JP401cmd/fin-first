    ...
    capabilityGroups: [
      {
        ...
        items: [
          ...
          { title: 'Zelf kiezen waar de app voor je opent', desc: 'Je Overzicht of meteen je budgetten — jouw startscherm. Je kiest het in het zoekscherm (⌘K) of bij Mijn → Weergave en uiterlijk; op mobiel houd je de middelste navigatieknop een seconde ingedrukt om er direct heen te gaan.' },
      ...
      },
      {
        ...
        items: [
          ...
          { title: 'Nalopen waar de app mee rekent', desc: 'In vijf stappen — je plan, leven na stoppen, wat er binnenkomt, je huis en hoe je potten werken — zie je per keuze waar de app nu mee rekent, wat een andere keuze met je vrijheidsleeftijd doet en waarom het ertoe doet. Bevestig wat klopt of pas het aan; de Voorkeuren-kaart op Toekomst houdt bij hoeveel stappen je al nagelopen hebt en zet een stap weer open als je situatie verandert.' },
          { title: 'Zelf zeggen of je huis meetelt voor je vrijheid', desc: 'Zodra je je woning toevoegt, vraagt de app wat hij ermee moet doen. Verkoop je hem ooit? Dan telt de opbrengst pas mee op het moment dat je verkoopt — tot die tijd kun je er niet van leven. Of telt hij helemaal niet mee, omdat je er blijft wonen? Dan rekent de app je vrijheid uit zonder je huis. Zo wordt de waarde van de stenen waarin je woont nooit als besteedbaar geld geteld zonder dat jij dat zei, en staat er overal bij welke van de twee je ziet.' },
          { title: 'Aan vijf knoppen draaien en zien of je plan het haalt', desc: 'Onder je grafiek staan vijf knoppen: meer verdienen, minder uitgeven, je uitgave na pensioen, je nalatenschap en je stopleeftijd. Elke knop kleurt rood, oranje of groen — rood betekent dat je plan het niet haalt, oranje dat het net haalt, groen dat er ruim marge in zit — en eronder staat vanaf welke stand die grens ligt. Verschuif één knop en de grenzen op de andere schuiven mee, want ze hangen van elkaar af: wie meer verdient, hoeft minder te bezuinigen. Je plan verandert er niet van totdat je zegt dat dit je doel is.' },
      ...
      },
      {
        ...
        items: [
          ...
          { title: 'Je eerdere gesprekken teruglezen en oppakken waar je gebleven was', desc: 'Je gesprekken met Fin blijven bewaard: je ziet ze op een rij, hervat er een met één tik, geeft ze een naam die jij herkent, of gooit er een weg. Vroeger was een gesprek weg zodra je de pagina ververste.' },
          { title: 'Zelf bepalen waar je gesprekken bewaard blijven — of helemaal niet', desc: 'Kies of je gesprekken meegaan met je account (dan heb je ze op elk apparaat), alleen op dit toestel blijven (dan raak je ze kwijt als je je browsergegevens leegt), of dat er niets bewaard wordt. Wat je met de privé-AI op je eigen toestel besprak, gaat sowieso nooit naar onze servers — ook niet als je "bij mijn account" koos. En ons team kan je gesprekken niet inzien.' },
          { title: 'Een vraag om mee te beginnen als je niet weet wat je moet vragen', desc: 'Een leeg chatvenster is lastig. Fin stelt een paar vragen voor die passen bij het scherm waar je bent en bij de gegevens die je al hebt ingevuld — tik erop en het gesprek begint.' },
