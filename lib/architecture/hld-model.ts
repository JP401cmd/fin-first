    ...
    capabilityGroups: [
      {
        ...
        items: [
          ...
          { title: 'Zelf kiezen waar de app voor je opent', desc: 'Je Overzicht of meteen je budgetten — jouw startscherm. Je kiest het in het zoekscherm (⌘K) of bij Mijn → Uiterlijk; op mobiel houd je de middelste navigatieknop anderhalve seconde ingedrukt om er direct heen te gaan.' },
