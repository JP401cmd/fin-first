...
const ROUTE_ALIASES: Record<string, string> = {
  ...
  '/core/budgets': '/overzicht/cashflow/budget',
  '/core/cash': '/overzicht/cashflow',
  ...
  '/core/transactions': '/overzicht/cashflow/transacties',
  '/core/transacties': '/overzicht/cashflow/transacties',
  '/core/bank': '/overzicht/cashflow',
  '/core/rekeningen': '/overzicht/cashflow',
