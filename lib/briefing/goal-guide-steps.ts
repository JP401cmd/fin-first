...
export const DEFAULT_GOAL_GUIDE_STEPS: Record<GoalSlug, ModuleGuideStep[]> = {
  ...
  'vermogen-overzicht': [
    { key: 'vo_first_asset', label: 'Voeg je eerste bezit toe', href: '/core/assets' },
    { key: 'vo_assets_3', label: 'Voeg 3 bezittingen toe', href: '/core/assets' },
    { key: 'vo_debts', label: 'Registreer je schulden (of bevestig: geen)', href: '/core/debts' },
    { key: 'vo_first_snapshot', label: 'Maak je eerste vermogenssnapshot', href: '/core' },
    { key: 'vo_box3', label: 'Bekijk je Box 3 inzicht', href: '/core/belasting' },
  ],
  noodfonds: [
    { key: 'nf_expenses', label: 'Bevestig je geschatte maandlasten', href: '/identity/profiel#expenses' },
    { key: 'nf_calc', label: 'Stel je doelbuffer in (3 of 6 maanden)', href: '/will' },
    { key: 'nf_link_asset', label: 'Koppel je spaarrekening aan dit doel', href: '/will' },
    { key: 'nf_monthly_save', label: 'Plan een maandelijkse storting', href: '/core/budgets' },
    { key: 'nf_milestone_30', label: 'Eerste mijlpaal: 1 maand buffer', href: '/will' },
  ],
  'schulden-aflossen': [
    { key: 'sa_register', label: 'Registreer al je schulden', href: '/core/debts' },
    { key: 'sa_priorities', label: 'Sorteer op rente (hoogste eerst)', href: '/core/debts' },
    { key: 'sa_payoff_goal', label: 'Stel een aflossingsdoel in', href: '/will' },
    { key: 'sa_extra', label: 'Plan een extra maandelijkse aflossing', href: '/core/debts' },
    { key: 'sa_first_progress', label: 'Eerste aflossingsmoment vastleggen', href: '/core/debts' },
  ],
  'eerder-stoppen': [
    { key: 'es_assets', label: 'Vermogen registreren', href: '/core/assets' },
    { key: 'es_expenses', label: 'Maandlasten in beeld', href: '/core/budgets' },
    { key: 'es_horizon', label: 'Vul rendement & inflatie in', href: '/identity/instellingen' },
    { key: 'es_fire_calc', label: 'Zie je FIRE-leeftijd', href: '/horizon' },
    { key: 'es_scenario', label: 'Speel met scenario’s', href: '/horizon/whatif' },
    { key: 'es_lifeevent', label: 'Voeg levensgebeurtenissen toe', href: '/horizon' },
  ],
  'bewust-leven': [
    { key: 'bl_intent', label: 'Definieer je waarom', href: '/will' },
    { key: 'bl_first_checkin', label: 'Doe je eerste maand-checkin', href: '/core/checkin' },
    { key: 'bl_pattern', label: 'Bekijk je beslissingspatronen', href: '/will' },
    { key: 'bl_inzicht', label: 'Lees een AI-voorstel', href: '/will' },
    { key: 'bl_completed_action', label: 'Voer minimaal 1 actie uit', href: '/will' },
  ],
}
