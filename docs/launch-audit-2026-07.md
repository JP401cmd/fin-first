...
| **D / AC4** | Lighthouse landing / `/overzicht` / `/toekomst` | chrome-devtools `lighthouse_audit` | ⏳-menselijk | Vereist draaiende server + geseed ingelogd account. Geen scores vastgelegd. |
