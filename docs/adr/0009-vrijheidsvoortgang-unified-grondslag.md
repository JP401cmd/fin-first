...
- Bewust toegestane afwijkingen, intern consistent en gedocumenteerd in code:
  ...
  - **AI shared-context** (`lib/ai/context/shared-context.ts:79`) gebruikt nog de oude grondslag via `computeCoreData`/`computeFreedomPercentage` — bekende open follow-up om ook op `computeFreedomProgress` te zetten.
