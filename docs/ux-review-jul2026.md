...
**Spoor 2 — P1: kernflow-frictie (bug-fix/kleine-aanpassing per item, 2-3 sessies).**
...
**Spoor 3 — Consistentie-sweeps (refactor-pijplijn, mechanisch, sterk parallelliseerbaar, 2-3 sessies).**
...
**Spoor 4 — Verrijking (na de Spoor 0-besluiten fors verkleind, 1-2 sessies).**
