...
/**
 * Verification API for Feature #125: Debt trajectory overlays real vs projected.
 * Tests that the DebtTrajectoryChart component and its data flow work correctly.
 */
export async function GET() {
  ...
  // Test 8: Debts page file contains DebtTrajectoryChart component
  try {
    ...
    tests.push({
      name: 'DebtTrajectoryChart integrated in debt detail modal',
