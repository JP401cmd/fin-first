 ...
 *
 * Vervangt /horizon. Voor nu rendert HorizonPage zodat preview-functionaliteit
 * meteen werkt onder de nieuwe URL. In komende fases wordt HorizonPage zelf
 * hervormd naar de vier-tab-structuur:
