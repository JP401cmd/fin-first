...
const GAPS: { titel: string; onderdeel: string; impact: string; ernst: Ernst; files: string }[] = [
  { titel: 'Pot-regels niet aangesloten op de engine', onderdeel: 'Voorkeuren', ernst: 'hoog', impact: 'Onttrekkingsvolgorde, verdeling-bij-toename en onttrekking-bij-afname worden opgeslagen, gevalideerd én getekend, maar bereiken runHorizonLedger nooit. expandGroupsToAssetTypes heeft 0 importers; de engine gebruikt altijd DEFAULT_WITHDRAWAL_ORDER (lib/horizon-engine/strategies.ts).', files: 'lib/pot-rules.ts · lib/horizon-engine/strategies.ts · components/future/regels/*' },
