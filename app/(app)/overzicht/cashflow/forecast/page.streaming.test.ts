 ...
 * ADR 0077). De GETALSMATIGE gelijkheid van die vijf is een andere test:
...
describe('forecast-loader — draait op de slanke forecast-laag (ADR 0077)', () => {
  ...
  it('geeft de slanke laag ONGEFILTERD door — geen tussenliggende hersom', () => {
    ...
    // rekenweg die ADR 0077 uitsluit.
